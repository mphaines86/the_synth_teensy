...
extern volatile uint16_t phase_accumulators[8];      //-Wave phase accumolators
...
extern volatile uint16_t *envs[8];                                  //-Envelopte selector [address of envelope in memory]
extern volatile uint16_t  envelope_phase[8]; //-Envelope phase accumolator
