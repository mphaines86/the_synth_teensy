...
extern const uint8_t Arr1_wave[];
extern const uint8_t Swannee_wave[];
extern const uint8_t strchoir_wave[];
extern const uint8_t bassgt_wave[];
extern const uint8_t cello3_wave[];
...
extern struct Voice Arr1;
extern struct Voice Swannee;
extern struct Voice Strchoir;
extern struct Voice Bassgt;
extern struct Voice cello3;
